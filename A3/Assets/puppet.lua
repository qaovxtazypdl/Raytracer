...
furUpperBottom = gr.material({1.0,0.2,0.2}, {0.8,0.3,0.4}, 15)
...
shoulder_j = gr.joint('shoulder_j', {0,0,0}, {-25,0,25})
left_wing = gr.mesh('sphere', 'left_wing')
left_wing_j = gr.joint('left_wing_j', {0,0,0}, {-45,15,45})
right_wing = gr.mesh('sphere', 'right_wing')
right_wing_j = gr.joint('right_wing_j', {0,0,0}, {-45,-15,45})
left_wing_outer = gr.mesh('sphere', 'left_wing_outer')
left_wing_outer_j = gr.joint('left_wing_outer_j', {0,0,0}, {-45,-35,45})
right_wing_outer = gr.mesh('sphere', 'right_wing_outer')
right_wing_outer_j = gr.joint('right_wing_outer_j', {0,0,0}, {-45,35,45})
...
-- start modelling
torso:set_material(furUpperTop)
...
-- legs
left_thigh:set_material(furThigh)
...
right_thigh:set_material(furThigh)
...
left_talons:set_material(furTalon)
...
right_talons:set_material(furTalon)
...
tail_feather_middle:set_material(furTailOuter)
tail_feather_middle:rotate('z',45)
tail_feather_middle:scale(1.5,1.7,0.34)

tail_feather_left:set_material(furTailOuter)
tail_feather_left:rotate('z',45)
tail_feather_left:scale(1.5,2.67,0.34)

tail_feather_right:set_material(furTailOuter)
tail_feather_right:rotate('z',45)
tail_feather_right:scale(1.5,2.67,0.34)

-- talons
l_talon_l = gr.mesh('sphere', 'l_talon_l')
l_talon_r = gr.mesh('sphere', 'l_talon_r')
r_talon_l = gr.mesh('sphere', 'r_talon_l')
r_talon_r = gr.mesh('sphere', 'r_talon_r')
...
l_talon_l:set_material(furTalon)
l_talon_l:scale(0.0116,0.085,0.0224)
l_talon_l:translate(0,0.06,0)
l_talon_l:rotate('z', 15)
l_talon_l:translate(0,-0.06,0)
l_talon_l:scale(1/0.0116,1/0.135,1/0.0324)

l_talon_r:set_material(furTalon)
l_talon_r:scale(0.0116,0.085,0.0224)
...
r_talon_l:set_material(furTalon)
r_talon_l:scale(0.0116,0.085,0.0224)
r_talon_l:translate(0,0.06,0)
r_talon_l:rotate('z', 15)
r_talon_l:translate(0,-0.06,0)
r_talon_l:scale(1/0.0116,1/0.135,1/0.0324)

r_talon_r:set_material(furTalon)
r_talon_r:scale(0.0116,0.085,0.0224)
...
belly_torso:set_material(furUpperBottom)
belly_torso:translate(0,0,-0.001)

belly_abdomen:set_material(furLowerBottom)
