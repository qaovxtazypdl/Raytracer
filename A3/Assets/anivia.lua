...
left_talons_j = gr.joint('left_talons_j', {-20,-20,40}, {0,0,0})
right_talons = gr.mesh('cube', 'abdomen')
right_talons_j = gr.joint('right_talons_j', {-40,40,40}, {0,0,0})
...
tail_j = gr.joint('tail_j', {-30,0,30}, {-10,0,10})
...
shoulder_j:scale(1/0.25,1/0.5,1/0.18)
