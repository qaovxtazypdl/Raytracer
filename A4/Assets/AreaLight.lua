...
left_cone = gr.cone('left_cone')
left_cone:scale(1/50,1/50,1/100)
left_cone:scale(5,10,10)
left_cone:translate(0,0.07,0)
left_cone:translate(-0.34,0,0.36)
left_cone:set_material(polgold)
plane:add_child(left_cone)

right_cone = gr.cone('right_cone')
right_cone:scale(1/50,1/50,1/100)
right_cone:scale(5,10,10)
right_cone:translate(0,0.07,0)
right_cone:translate(0.399,0,0.36)
...
central_torus:translate(0.0,0.2,.5)
...
central_cylinder:translate(0.0,0.23,0.5)
