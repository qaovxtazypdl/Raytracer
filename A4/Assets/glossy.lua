...
perfect_crystal = gr.material_extended({0.0, 0.0, 0.0}, {2.0, 2.0, 2.0}, 1000, 1.333, 0, 1.0, 0)
mirror_water = gr.material_extended({0.1, 0.16, 0.15}, {1.5,1.5,1.5}, 120, 1.333, 0, 0, 0)
mirror_opaque = gr.material_extended({0.5, 0.56, 0.55}, {0.75,0.75,0.75}, 120, 1.333, 1, 0.7, 0)
...
checkerboard = gr.texture("Assets/checkerboard.png")
...
refractive_sphere:set_material(ruby_crystal)
plane:add_child(refractive_sphere)

reflective_sphere = gr.sphere('reflective_sphere')
reflective_sphere:scale(1/50,1/50,1/100)
reflective_sphere:scale(7,7,7)
reflective_sphere:translate(0,0.13,0)
reflective_sphere:translate(-0.17,0.1,0.3)
reflective_sphere:set_material(mirror_opaque)
plane:add_child(reflective_sphere)

ground_cube = gr.cube('ground_cube')
ground_cube:scale(2,0.05,1.6)
ground_cube:translate(-1,-0.047,-0.87)
ground_cube:set_material(stone)
ground_cube:set_texture(checkerboard)
plane:add_child(ground_cube)
