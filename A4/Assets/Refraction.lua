...
chrome_glass = gr.material_extended({0.4, 0.4, 0.4}, {0.974597, 0.974597, 0.974597}, 76.8, 1.5, 0)
...
central_cylinder:set_material(chrome_glass)
...
near_sphere:set_material(mirror_water)
