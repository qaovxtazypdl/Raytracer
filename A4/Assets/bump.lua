...
ground_cylinder:set_bumps(texture_checkerboard)
...
central_cylinder:set_bumps(texture_planks)
...
central_cylinder_inner:set_bumps(texture_bricks)
cupsg = gr.csg('cupsg')
...
central_cone:set_bumps(texture_bricks)
...
central_hyperboloid:set_bumps(texture_planks)
...
central_torus:set_bumps(texture_planks)
...
central_cube:set_bumps(texture_cubemap)
...
central_sphere:set_bumps(texture_globe)
