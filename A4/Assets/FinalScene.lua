...
flame1 = gr.light({-55,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame1s = gr.spherical_light({-55,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
flame2 = gr.light({-55,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame2s = gr.spherical_light({-55,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
flame3 = gr.light({-55,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame3s = gr.spherical_light({-55,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
flame4 = gr.light({62,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame4s = gr.spherical_light({62,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
flame5 = gr.light({62,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame5s = gr.spherical_light({62,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
flame6 = gr.light({62,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00021})
flame6s = gr.spherical_light({62,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00021}, 2.0)
...
gr.render(scene, 'FinalScene.png', 1280, 720, {0, 0, 100}, {0, 0, -100}, {0, 1, 0}, 50, {0.23, 0.2, 0.14}, {primary_light, flame1s, flame2s, flame3s, flame4s, flame5s, flame6s, backlight})
