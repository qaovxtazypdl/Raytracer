...
primary_light = gr.spherical_light({-8000, 8000, 0}, {0.45, 0.3, 0.1}, {1, 0, 0}, 300)
primary_light_pt = gr.light({-8000, 8000, 0}, {0.45, 0.3, 0.1}, {1, 0, 0})
backlight = gr.light({0, 400, 400}, {0.7,0.7,0.7}, {1, 0, 0})
flame1 = gr.light({-55,-25,-55}, {0.29, 0.14, 0.04}, {1,0,0.00016})
flame1s = gr.spherical_light({-55,-25,-55}, {0.29, 0.14, 0.04}, {1,0,0.00016}, 2.5)
flame2 = gr.light({-55,-25,-145}, {0.29, 0.14, 0.04}, {1,0,0.00016})
flame2s = gr.spherical_light({-55,-25,-145}, {0.29, 0.14, 0.04}, {1,0,0.00016}, 2.5)
flame3 = gr.light({-55,-25,-235}, {0.29, 0.14, 0.04}, {1,0,0.00016})
flame4 = gr.light({62,-25,-55}, {0.29, 0.14, 0.04}, {1,0,0.00016})
flame5 = gr.light({62,-25,-145}, {0.29, 0.14, 0.04}, {1,0,0.00016})
flame6 = gr.light({62,-25,-235}, {0.29, 0.14, 0.04}, {1,0,0.00016})
...
gr.render(scene, 'FinalScene.png', 888, 500, {0, 0, 100}, {0, 0, -100}, {0, 1, 0}, 50, {0.2, 0.2, 0.2}, {primary_light_pt, flame1, flame2, flame3, flame4, flame5, flame6, backlight})
