...
s_helmet:set_material(perfectCanvas)
...
s_helmet_inner:set_material(perfectCanvas)
...
s_helmet_eyehole:set_material(perfectCanvas)
...
s_helmet_mouthhole:set_material(perfectCanvas)
...
s_body_frame:set_material(perfectCanvas)
...
thigh_socket:set_material(perfectCanvas)
...
thigh:set_material(perfectCanvas)
...
thigh_bounds:set_material(perfectCanvas)
...
kneecap:set_material(perfectCanvas)
...
shin:set_material(perfectCanvas)
...
heel:set_material(perfectCanvas)
...
shoe:set_material(perfectCanvas)
...
shoe_differ:set_material(perfectCanvas)
...
shoulder:set_material(perfectCanvas)
...
arm_top:set_material(perfectCanvas)
...
arm_top_bounds:set_material(perfectCanvas)
...
elbow:set_material(perfectCanvas)
...
arm:translate(0,4,0)
arm:rotate('z', -55)
arm:set_material(perfectCanvas)
...
handle:set_material(perfectCanvas)
...
handle_cap:set_material(perfectCanvas)
...
hilt:set_material(perfectCanvas)
...
hilt_left:set_material(perfectCanvas)
...
hilt_right:set_material(perfectCanvas)
...
gr.render(scene, 'FinalScene.png', 888, 500,
    ...
    {0.2, 0.2, 0.2}, {primary_light, test_inner_light})
