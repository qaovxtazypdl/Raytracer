...
groundCanvas = gr.material_extended({0.65, 0.65, 0.65}, {0.8, 0.5, 0.3}, 150, 1, 1, 0.3, 0)
woodCanvas = gr.material({0.5, 0.5, 0.6}, {0.42, 0.32, 0.0}, 30)
pillarCanvas = gr.material({0.85, 0.79, 0.85}, {0.54, 0.44, 0.55}, 200)
...
crystal = gr.material_extended({0.3, 0.2, 0.3}, {2.0, 2.0, 2.0}, 1000, 1.23, 0, 0, 0)
...
--gr.render(scene, 'FinalScene.png', 888, 500, {0, 0, 100}, {0, 0, -100}, {0, 1, 0}, 50, {0.2, 0.2, 0.2}, {primary_light, flame2, backlight})
