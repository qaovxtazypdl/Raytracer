...
primary_light = gr.spherical_light({-8000, 8000, 0}, {0.52, 0.22, 0.04}, {1, 0, 0}, 300)
primary_light_pt = gr.light({-8000, 8000, 0}, {0.52, 0.22, 0.04}, {1, 0, 0})
backlight = gr.light({0, 400, 400}, {0.7,0.7,0.7}, {1, 0, 0})
flame1 = gr.light({-55,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00015})
flame1s = gr.spherical_light({-55,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00015}, 2.5)
