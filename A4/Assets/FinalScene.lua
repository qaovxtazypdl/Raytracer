...
shoe:set_texture(t_wood)
shoe:set_bumps(t_wood, 'rgb')
...
shoe_differ:set_texture(t_woodplanks)
shoe_differ:set_bumps(t_woodplanks, 'rgb')
...
arm_top_bounds:set_texture(t_platesteel)
arm_top_bounds:set_bumps(t_platesteel, 'rgb')
