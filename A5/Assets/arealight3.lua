...
planar_light = gr.planar_light({100, 90, -25}, {1.0, 0.6, 0}, {1, 0, 0}, {0, 0, 5}, {0, 5, 0})
planar_light_pt = gr.light({100, 90, -25}, {1.0, 0.6, 0}, {1, 0, 0}, {0, 0, 5}, {0, 5, 0})
spherical_light = gr.spherical_light({-105, 135, -75}, {0.0, 0.4, 1.0}, {1, 0, 0}, 4.0)
spherical_light_pt = gr.light({-105, 135, -75}, {0.0, 0.4, 1.0}, {1, 0, 0}, 4.0)
...
gr.render(scene, 'area_light3.png', 800, 700,
