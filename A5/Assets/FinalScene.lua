...
backlight = gr.light({0, 400, 530}, {0.7,0.7,0.7}, {1, 0, 0})
flame1 = gr.light({-54,-25,-55}, {0.35, 0.138, 0.03}, {1,0,0.00010})
...
backwindow:translate(5,22,-510)
backwindow:add_child(i_window)

backwindowpane = gr.node('backwindowpane')
backwindowpane:scale(160,120,10)
backwindowpane:translate(5,22,-520)
