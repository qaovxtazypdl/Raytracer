...
flame1 = gr.light({-54,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame1s = gr.spherical_light({-54,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
flame2 = gr.light({-54,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame2s = gr.spherical_light({-54,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
flame3 = gr.light({-54,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame3s = gr.spherical_light({-54,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
flame4 = gr.light({61,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame4s = gr.spherical_light({61,-25,-55}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
flame5 = gr.light({61,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame5s = gr.spherical_light({61,-25,-145}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
flame6 = gr.light({61,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00032})
flame6s = gr.spherical_light({61,-25,-235}, {0.34, 0.15, 0.04}, {1,0,0.00032}, 2.0)
