...
mirror_water = gr.material_extended({0.1, 0.16, 0.15}, {1.5,1.5,1.5}, 120, 1, 0, 0, 0)
chrome_glass = gr.material_extended({0.4, 0.4, 0.4}, {1.4, 1.4, 1.4}, 76.8, 1, 0.5, 0, 0)
ruby_crystal = gr.material_extended({0.61424, 0.04136, 0.04136}, {1.527811, 1.326959, 1.326959}, 76.8, 1, 0.3, 0, 0)
perfect_crystal = gr.material_extended({0.1, 0.1, 0.1}, {2.0, 2.0, 2.0}, 1000, 1, 0.4, 0, 0)
...
ground = gr.material_extended({0.427451, 0.470588, 0.541176}, {0,0,0}, 9.84615, 0, 0, 0, 0)
...
central_cylinder:rotate('z', 90)
central_cylinder:translate(0,0.13,0)
central_cylinder:translate(-0.12,0,0.5)
central_cylinder:set_material(mirror_water)
plane:add_child(central_cylinder)

near_sphere = gr.sphere('near_sphere')
near_sphere:scale(1/50,1/50,1/100)
near_sphere:scale(5,5,5)
near_sphere:translate(0,0.13,0)
near_sphere:translate(0.17,0.1,0.4)
near_sphere:set_material(chrome_glass)
plane:add_child(near_sphere)
