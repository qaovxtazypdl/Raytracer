...
ground_cylinder:set_texture(texture_checkerboard, 'rgb')
...
central_cylinder:set_texture(texture_planks)
...
central_cylinder_inner:set_texture(texture_bricks)
...
central_cone:set_texture(texture_bricks)
...
central_hyperboloid:set_texture(texture_planks)
...
central_cube:set_texture(texture_cubemap)
...
central_sphere:set_texture(texture_globe)
central_sphere:set_bumps(texture_globe, 'rgb')
plane:add_child(central_sphere)

gr.render(scene, 'bumptextureright.png', 800, 700,
